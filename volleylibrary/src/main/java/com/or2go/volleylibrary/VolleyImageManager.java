...
public class VolleyImageManager {
    public static VolleyImageManager mInstance;
     ...
     */
    private VolleyImageManager(Context context) {
        mCtx = context;
     ...
     */
    public static synchronized VolleyImageManager getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new VolleyImageManager(context);
        }
        return mInstance;
    }
